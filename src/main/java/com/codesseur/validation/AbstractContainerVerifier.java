...
public abstract class AbstractContainerVerifier<E, L extends Collection<E>, C extends CollectionContainer<E, L>, S extends AbstractContainerVerifier<E, L, C, S>> extends
  ...
  public S isEmpty() {
    return isNotNull().then().satisfies(CollectionContainer::isEmpty, () -> Failures.of("NOT_EMPTY"));
  }

  public S isNotEmpty() {
    return isNotNull().then().violates(CollectionContainer::isEmpty, () -> Failures.of("EMPTY"));
  }
  ...
  public S isSubsetOf(Iterable<? extends E> elements) {
    ...
    return isNotNull().then()
        .satisfies(c -> set.containsAll(c.value()), () -> Failures.of("NOT_SUBSET", Tuple.of("elements", elements)));
  }
